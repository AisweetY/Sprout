...
class AppColors {
  ...
  factory AppColors.light() {
    return const AppColors(
      ...
      textSecondary: Color(0xFF6E6E6E), // 淡墨
      textTertiary: Color(0xFFA0A0A0), // 浅墨
      // 品牌色：竹青系
  ...
  factory AppColors.dark() {
    return const AppColors(
      ...
      // 文字层级
      textPrimary: Color(0xFFF0F1EE),
      textSecondary: Color(0xFF9DA09B),
      textTertiary: Color(0xFF6A6D69),
      // 品牌色：暗色下更亮的竹绿
      ...
      // 分割与边框
      divider: Color(0xFF363936),
      border: Color(0xFF454845),
    );
  }
}
