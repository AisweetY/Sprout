---
name: find-skills
description: Search for community Codex skills by topic or framework
invocation: user
...
Search the community skill registry for Codex skills relevant to your project.
...
After installation, verify the skill was added by checking for the SKILL.md file in `.Codex/skills/`.
