...
This skill operates on agentic-rig itself — the CLI tool that generates Codex configurations. You have access to:
- The agentic-rig source code (current working directory should be the agentic-rig repo)
- Feedback data from past analyses stored in `.Codex/agentic-rig/feedback/`
- User-generated templates in `.Codex/agentic-rig/templates/`
...
Read all feedback JSON files from `.Codex/agentic-rig/feedback/`:
...
Read `.Codex/skills/project-setup/references/analysis-heuristics.md`:
...
### Step 1.7: Review agentic-rig's Own AGENTS.md

Read `AGENTS.md` in the agentic-rig repo root:
...
### AGENTS.md Updates (D# items)
- Edit `AGENTS.md` in the agentic-rig repo root
...
- [x] D1: Updated AGENTS.md with new commands
- [ ] W1: Skipped by user
